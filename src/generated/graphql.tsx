...
export type CreateOrderLinksInput = {
  deliveryOrderId: Scalars['ID']['input'];
  extractionOrderId?: InputMaybe<Scalars['ID']['input']>;
  loadingOrderId?: InputMaybe<Scalars['ID']['input']>;
};
...
export type DeliveryOrder = {
  ...
  /** @deprecated Overridden by orderLinks. */
...
export type ExtractionOrder = {
  __typename?: 'ExtractionOrder';
  customerBranch?: Maybe<CustomerBranch>;
  data?: Maybe<Scalars['JSON']['output']>;
  deliveryDate?: Maybe<Scalars['ISO8601Date']['output']>;
  deliveryDateTimestamp?: Maybe<Scalars['Int']['output']>;
  deliveryInstruction?: Maybe<Scalars['String']['output']>;
  expectedDeliveryTimeTimestamp?: Maybe<Scalars['Int']['output']>;
  extractionOrderLineItems: Array<ExtractionOrderLineItem>;
  id: Scalars['ID']['output'];
  lineItemSummary?: Maybe<Array<LineItem>>;
  lineItems: Array<ExtractionOrderLineItem>;
  linkedOrders?: Maybe<Array<LoadingOrder>>;
  notes?: Maybe<Array<Note>>;
  orderGroup?: Maybe<OrderGroup>;
  orderGroupId?: Maybe<Scalars['Int']['output']>;
  orderLinks?: Maybe<Array<OrderLink>>;
  orderNumber?: Maybe<Scalars['String']['output']>;
  orderedProductsSummary?: Maybe<Array<ExtractionOrderOrderedProductsSummary>>;
  postDeliveryNote?: Maybe<Note>;
  postDeliveryPhotos?: Maybe<Array<PandaDocument>>;
  products?: Maybe<Array<Product>>;
  quickbookQueueStatus?: Maybe<Scalars['String']['output']>;
...
export type ExtractionOrderLineItem = {
  __typename?: 'ExtractionOrderLineItem';
  asset?: Maybe<Asset>;
  canSyncRequestedLoadingVolume: Scalars['Boolean']['output'];
  data?: Maybe<Scalars['JSON']['output']>;
  id: Scalars['ID']['output'];
...
export type ExtractionOrderOrderedProductsSummary = {
  __typename?: 'ExtractionOrderOrderedProductsSummary';
  productId?: Maybe<Scalars['ID']['output']>;
  totalExtractedVolume: Scalars['Float']['output'];
  totalRequestedVolume: Scalars['Float']['output'];
  totalTopOffRequestCount: Scalars['Int']['output'];
};
...
export type OrderGroup = {
  ...
  extractionOrder?: Maybe<ExtractionOrder>;
  fees?: Maybe<Array<Fee>>;
  hub?: Maybe<Hub>;
  id: Scalars['ID']['output'];
  lineOfService?: Maybe<LineOfService>;
...
export type Query = {
  ...
  searchExtractionOrders: Array<ExtractionOrder>;
...
export type QueryExtractionOrderArgs = {
  id: Scalars['ID']['input'];
};
...
export type QuerySearchExtractionOrdersArgs = {
  filter?: InputMaybe<OrderGroupFiltersInput>;
  search: Scalars['String']['input'];
};
...
export type FetchFilteredOrderWellQueryVariables = Exact<{ [key: string]: never; }>;
...
export const FetchFilteredOrderWellDocument = gql`
    query FetchFilteredOrderWell {
  filteredOrderWell(filter: {fromTimestamp: 1707070500, toTimestamp: 1707156840}) {
    collection {
      id
      status
      type
